<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="<?php echo base_url();?>">Fix Soft</a>.</strong> Todoslos derechos reservados.
  </footer>
  </div>
...
<!---->
<script src="<?php echo base_url('assets/sources/js/nuevaConsulta.js');?>"></script>
</body>
</html>